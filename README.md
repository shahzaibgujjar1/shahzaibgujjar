...
### **Project Overview**
**Product:** Lavender Oil Dog Deodorizing & Calming Spray
**Objective:** Launch a new product in a competitive market and generate profitable sales (ROAS).
**My Role:** Meta Ads Strategist & Media Buyer.
...
## 3. The Execution (Ad Setup) ⚙️

### **The Funnel Structure**
* **Top of Funnel (TOF):** Broad targeting + Interest stack (Pet Smart, Chewy).
* **Middle of Funnel (MOF):** Retargeting video viewers (50%) with a "Social Proof" ad (Reviews).
* **Bottom of Funnel (BOF):** Dynamic Catalog Sales for "Add to Cart" abandoners.

### **Ad Creative Strategy (A/B Testing)**
I tested two different hooks to see what worked best:
* **Creative A (The Problem Solver):** "Does your house smell like 'Wet Dog'?" (Focus: Hygiene)
* **Creative B (The Emotional Hook):** "Help your pup relax while smelling amazing." (Focus: Calming)
...
>
> 🐶 *Vet Approved. Paraben Free.*
>
> 👉 **Get 20% OFF Today:** [Link]
...
| **Cost Per Purchase (CPP)** | **$8.50** (Product Price: $29.99) |
| **CTR (Link Click-Through Rate)** | **1.8%** (Industry avg: 0.9%) |
...
![Google Ads Results](https://github.com/user-attachments/assets/45456f99-1772-4836-b536-ffddba161e64)
